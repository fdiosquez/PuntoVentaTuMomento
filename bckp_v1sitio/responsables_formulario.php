<?php
  ...
  $id_responsable = 0; // siempre es nuevo, salvo que venga un valor > 0
  $descripcion = "";  
  $email = "";
  $telefono = "";
  ...
  $accion =  ($id_responsable == 0 ) ? "nuevo" : "modificar";
  ...
  <body>
    ...
    <header id="header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-10">
            <h2><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Clientes <small> / Formulario de clientes</small></h2>
          </div>          
        </div>
      </div>
    </header>
          ...
          <div class="col-md-3">
            ...
            <div class="panel panel-default">
                <div class="panel-heading main-color-bg">
                  <h3 class="panel-title"><?php  echo ($id_responsable == 0 ? "Nuevo responsable" : "Modificar responsable"); ?></h3>
                </div>
                <div class="panel-body">
                     
                  
                    <form id="formulario" action="responsables.php" method="post">
                      ...
                      <p>
                        ...
                        <input type="text" name="email"  class="form-control" placeholder="" value="<?php echo $email;?>">
                      </p>
                      ...
                      <p>
                                <button type="button"  class="btn btn-default" onclick="location.href='responsables.php';" >Volver</button>                        
