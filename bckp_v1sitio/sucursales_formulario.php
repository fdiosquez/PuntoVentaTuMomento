<?php
  ...
  $id_sucursal = 0; // siempre es nuevo, salvo que venga un valor > 0
  $descripcion = "";  
  ...
  $accion =  ($id_sucursal == 0 ) ? "nuevo" : "modificar";
          ...
          <div class="col-md-3">
            ...
            <div class="panel panel-default">
                <div class="panel-heading main-color-bg">
                  <h3 class="panel-title"><?php  echo ($id_sucursal == 0 ? "Nueva Sucursal" : "Modificar Sucursal"); ?></h3>
                </div>
                <div class="panel-body">
                     
                  
                    <form id="formulario" action="sucursales.php" method="post">
                        <input type="hidden" name="id_sucursal"  value="<?php echo $id_sucursal?>" />
                        <input type="hidden" name="accion"  value="<?php echo $accion;?>" />
                        
                      <p>
                        <label for="descripcion">Descripcion</label>
                        <input type="text" name="descripcion"  class="form-control" placeholder="Ingrese nombre de sucursal" value="<?php echo $descripcion;?>">
                      </p>
                   
                      <p>
                                <button type="button"  class="btn btn-default" onclick="location.href='sucursales.php';" >Volver</button>                        
