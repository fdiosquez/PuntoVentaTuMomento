<?php
  ...
  $id_producto_tipo = 0; // siempre es nuevo, salvo que venga un valor > 0
  $descripcion = "";  

  if(isset($_REQUEST["id_producto_tipo"]))
  {

    $id_producto_tipo = $_REQUEST["id_producto_tipo"];

    $sql ="SELECT * FROM productos_tipos WHERE id_producto_tipo = $id_producto_tipo";                            		
  ...
  $accion =  ($id_producto_tipo == 0 ) ? "nuevo" : "modificar";
  ...
  <body>
    ...
    <header id="header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-10">
            <h2><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Tipos de Rubros <small> / Formulario de Rubros</small></h2>
          </div>          
        </div>
      </div>
    </header>
          ...
          <div class="col-md-3">
            ...
            <div class="panel panel-default">
                <div class="panel-heading main-color-bg">
                  <h3 class="panel-title"><?php  echo ($id_producto_tipo == 0 ? "Nuevo tipo Producto" : "Modificar tipo Producto"); ?></h3>
                </div>
                <div class="panel-body">
                     
                  
                    <form id="formulario" action="productos_tipo.php" method="post">
                        <input type="hidden" name="id_producto_tipo"  value="<?php echo $id_producto_tipo?>" />
                        <input type="hidden" name="accion"  value="<?php echo $accion;?>" />
                        
                      <p>
                        <label for="descripcion">Descripcion</label>
                        <input type="text" name="descripcion"  class="form-control" placeholder="Ingrese tipo de producto" value="<?php echo $descripcion;?>">
                      </p>
                   
                      <p>
                                <button type="button"  class="btn btn-default" onclick="location.href='productos_tipo.php';" >Volver</button>                        
